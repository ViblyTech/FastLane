...
function Hero() {
  return (
    <section className="relative isolate overflow-hidden">
      <div className="container-page relative pb-28 pt-24 sm:pb-40 sm:pt-40 lg:pt-48">
      ...
      <div className="container-page grid gap-16 py-28 sm:py-36 lg:grid-cols-[1.1fr_1fr] lg:gap-24">
        ...
        <ol className="flex flex-col justify-center divide-y divide-[var(--color-line-soft)] border-y border-[var(--color-line-soft)] text-lg">
          <li className="flex items-baseline gap-6 py-6">
            <span className="w-8 shrink-0 font-mono text-sm text-[var(--color-fg-muted)]">01</span>
            <span>Book a quote. We confirm same-day in most cases.</span>
          </li>
          <li className="flex items-baseline gap-6 py-6">
            <span className="w-8 shrink-0 font-mono text-sm text-[var(--color-fg-muted)]">02</span>
            <span>We come to you. Driveway, office, or in-shop.</span>
          </li>
          <li className="flex items-baseline gap-6 py-6">
            <span className="w-8 shrink-0 font-mono text-sm text-[var(--color-fg-muted)]">03</span>
...
function Book() {
  return (
    <section id="quote" className="scroll-mt-24 bg-[var(--color-canvas)]">
